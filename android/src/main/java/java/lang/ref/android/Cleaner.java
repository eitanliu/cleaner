...
public final class Cleaner {
    ...
    private static class Impl implements Api {
        java.lang.ref.compat.Cleaner cleaner;
        ...
        public void create(ThreadFactory threadFactory) {
            ...
            cleaner = java.lang.ref.compat.Cleaner.create(threadFactory);
        }

        @Override
        public Cleanable register(Object obj, Runnable action) {
            java.lang.ref.compat.Cleaner.Cleanable cleanable = cleaner.register(obj, action);
            return new CleanerWrapper(cleanable);
        }


        static final class CleanerWrapper implements Cleanable {
            java.lang.ref.compat.Cleaner.Cleanable cleanable;

            public CleanerWrapper(java.lang.ref.compat.Cleaner.Cleanable cleanable) {
                this.cleanable = cleanable;
            }
